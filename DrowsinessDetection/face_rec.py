...
from  DrowsinessDetection.eye_status import *


def init():
    face_cascPath = 'DrowsinessDetection/haarcascade_frontalface_alt.xml'
    # face_cascPath = 'lbpcascade_frontalface.xml'

    open_eye_cascPath = 'DrowsinessDetection/haarcascade_eye_tree_eyeglasses.xml'
    left_eye_cascPath = 'DrowsinessDetection/haarcascade_lefteye_2splits.xml'
    right_eye_cascPath = 'DrowsinessDetection/haarcascade_righteye_2splits.xml'
    dataset = 'faces'
    ...
    for (x, y, w, h) in faces:
        ...
        # which can detect open and closed eyes
            ...
            for (ex, ey, ew, eh) in right_eye:
                ...
                # cv2.putText(frame, "Eyes Closed", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 255, 0), 2)
